...
export default function Input<TFieldValues extends FieldValues = FieldValues>({
  ...
  register,
  rules,
  classNameInput = 'w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-5',
    ...
    <div className={'relative ' + className}>
      ...
      {rest.type === 'password' && openEye && (
        <svg
          ...
          strokeWidth={1.5}
          stroke='currentColor'
          className='absolute top-[37px] right-[5px] mr-2 h-5 w-5 cursor-pointer'
          onClick={toggleEye}
        >
          <path
            strokeLinecap='round'
